...
import glm.vec4.Vec4s.Companion.plus
import glm.vec4.Vec4s.Companion.div
import glm.vec4.Vec4s.Companion.times
import glm.vec4.Vec4s.Companion.rem
import glm.vec4.Vec4s.Companion.minus
