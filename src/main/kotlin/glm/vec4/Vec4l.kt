...
import glm.vec4.operators.vec4l_operators
import java.nio.*
...
class Vec4l(x: Long, y: Long, z: Long, w: Long) : Vec4t<Long>(x, y, z, w) {
    ...
    operator fun plus(b: glm.vec4.Vec4t<out Number>) = plus(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    fun plus(b: glm.vec4.Vec4t<out Number>, res: Vec4l = Vec4l()) = plus(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun plus_(b: glm.vec4.Vec4t<out Number>) = plus(this, this, b.x.L, b.y.L, b.z.L, b.w.L)


    operator fun minus(b: Number) = minus(Vec4l(), this, b.L, b.L, b.L, b.L)
    operator fun minus(b: glm.vec4.Vec4t<out Number>) = minus(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    fun minus(b: glm.vec4.Vec4t<out Number>, res: Vec4l = Vec4l()) = minus(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun minus_(b: glm.vec4.Vec4t<out Number>) = minus(this, this, b.x.L, b.y.L, b.z.L, b.w.L)


    operator fun times(b: Number) = times(Vec4l(), this, b.L, b.L, b.L, b.L)
    operator fun times(b: glm.vec4.Vec4t<out Number>) = times(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    fun times(b: glm.vec4.Vec4t<out Number>, res: Vec4l = Vec4l()) = times(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun times_(b: glm.vec4.Vec4t<out Number>) = times(this, this, b.x.L, b.y.L, b.z.L, b.w.L)


    operator fun div(b: Number) = div(Vec4l(), this, b.L, b.L, b.L, b.L)
    operator fun div(b: glm.vec4.Vec4t<out Number>) = div(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    fun div(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = div(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun div_(b: glm.vec4.Vec4t<out Number>) = div(this, this, b.x.L, b.y.L, b.z.L, b.w.L)


    operator fun rem(b: Number) = rem(Vec4l(), this, b.L, b.L, b.L, b.L)
    operator fun rem(b: glm.vec4.Vec4t<out Number>) = rem(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    fun rem(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = rem(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun rem_(b: glm.vec4.Vec4t<out Number>) = rem(this, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun and(b: glm.vec4.Vec4t<out Number>) = and(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)

    infix fun and_(b: Number) = and(this, this, b.L, b.L, b.L, b.L)
    infix fun and_(b: glm.vec4.Vec4t<out Number>) = and(this, this, b.x.L, b.y.L, b.z.L, b.w.L)

    fun and(b: Number, res: Vec4l) = and(res, this, b.L, b.L, b.L, b.L)
    fun and(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = and(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun or(b: glm.vec4.Vec4t<out Number>) = or(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)

    infix fun or_(b: Number) = or(this, this, b.L, b.L, b.L, b.L)
    infix fun or_(b: glm.vec4.Vec4t<out Number>) = or(this, this, b.x.L, b.y.L, b.z.L, b.w.L)

    fun or(b: Number, res: Vec4l) = or(res, this, b.L, b.L, b.L, b.L)
    fun or(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = or(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun xor(b: glm.vec4.Vec4t<out Number>) = xor(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)

    infix fun xor_(b: Number) = xor(this, this, b.L, b.L, b.L, b.L)
    infix fun xor_(b: glm.vec4.Vec4t<out Number>) = xor(this, this, b.x.L, b.y.L, b.z.L, b.w.L)

    fun xor(b: Number, res: Vec4l) = xor(res, this, b.L, b.L, b.L, b.L)
    fun xor(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = xor(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun shl(b: glm.vec4.Vec4t<out Number>) = shl(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)

    infix fun shl_(b: Number) = shl(this, this, b.L, b.L, b.L, b.L)
    infix fun shl_(b: glm.vec4.Vec4t<out Number>) = shl(this, this, b.x.L, b.y.L, b.z.L, b.w.L)

    fun shl(b: Number, res: Vec4l) = shl(res, this, b.L, b.L, b.L, b.L)
    fun shl(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = shl(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
    ...
    infix fun shr(b: glm.vec4.Vec4t<out Number>) = shr(Vec4l(), this, b.x.L, b.y.L, b.z.L, b.w.L)

    infix fun shr_(b: Number) = shr(this, this, b.L, b.L, b.L, b.L)
    infix fun shr_(b: glm.vec4.Vec4t<out Number>) = shr(this, this, b.x.L, b.y.L, b.z.L, b.w.L)

    fun shr(b: Number, res: Vec4l) = shr(res, this, b.L, b.L, b.L, b.L)
    fun shr(b: glm.vec4.Vec4t<out Number>, res: Vec4l) = shr(res, this, b.x.L, b.y.L, b.z.L, b.w.L)
