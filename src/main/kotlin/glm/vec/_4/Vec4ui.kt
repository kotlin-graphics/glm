...
class Vec4ui(x: Uint, y: Uint, z: Uint, w: Uint) : Vec4t<Uint>(x, y, z, w) {
    ...
    operator fun plus(b: Vec4t<Number>) = plus(Vec4ui(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun plus(b: Vec4t<Number>, res: Vec4ui = Vec4ui()) = plus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun minus(b: Vec4t<Number>) = minus(Vec4ui(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun minus(b: Vec4t<Number>, res: Vec4ui = Vec4ui()) = minus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun times(b: Vec4t<Number>) = times(Vec4ui(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun times(b: Vec4t<Number>, res: Vec4ui = Vec4ui()) = times(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
