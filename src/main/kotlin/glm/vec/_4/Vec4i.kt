...
import glm.vec._4.operators.vec4i_operators
...
open class Vec4i(x: Int, y: Int, z: Int, w: Int) : Vec4t<Int>(x, y, z, w) {
    ...
    operator fun plus(b: Vec4t<Number>) = plus(Vec4i(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun plus(b: Vec4t<Number>, res: Vec4i = Vec4i()) = plus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun minus(b: Vec4t<Number>) = minus(Vec4i(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun minus(b: Vec4t<Number>, res: Vec4i = Vec4i()) = minus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun times(b: Vec4t<Number>) = times(Vec4i(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun times(b: Vec4t<Number>, res: Vec4i = Vec4i()) = times(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
