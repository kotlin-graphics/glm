...
import glm.vec._4.operators.vec4ub_operators
...
class Vec4ub(x: Ubyte, y: Ubyte, z: Ubyte, w: Ubyte) : Vec4t<Ubyte>(x, y, z, w) {
    ...
    operator fun plus(b: Vec4t<Number>) = plus(Vec4ub(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun plus(b: Vec4t<Number>, res: Vec4ub = Vec4ub()) = plus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun minus(b: Vec4t<Number>) = minus(Vec4ub(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun minus(b: Vec4t<Number>, res: Vec4ub = Vec4ub()) = minus(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    operator fun times(b: Vec4t<Number>) = times(Vec4ub(), this, b.x.i, b.y.i, b.z.i, b.w.i)
    ...
    fun times(b: Vec4t<Number>, res: Vec4ub = Vec4ub()) = times(res, this, b.x.i, b.y.i, b.z.i, b.w.i)
