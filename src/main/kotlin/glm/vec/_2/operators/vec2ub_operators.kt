...
import glm.vec._2.Vec2ub.Companion.div
import glm.vec._2.Vec2ub.Companion.minus
import glm.vec._2.Vec2ub.Companion.plus
import glm.vec._2.Vec2ub.Companion.rem
import glm.vec._2.Vec2ub.Companion.times
import unsigned.*
...
infix fun Ubyte.plus_(b: Vec2ub) = plus(b, b, this, this)
...
infix fun Ubyte.minus_(b: Vec2ub) = minus(b, this, this, b)
...
infix fun Ubyte.times_(b: Vec2ub) = times(b, b, this, this)
...
infix fun Number.plus_(b: Vec2ub) = plus(b, b, this.i, this.i)
...
infix fun Number.minus_(b: Vec2ub) = minus(b, this.i, this.i, b)
...
infix fun Number.times_(b: Vec2ub) = times(b, b, this.i, this.i)
