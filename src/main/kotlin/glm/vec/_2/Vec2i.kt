...
import glm.vec._2.operators.vec2i_operators
...
class Vec2i(x: Int, y: Int) : Vec2t<Int>(x, y) {
    ...
    @JvmOverloads fun plus(bX: Int, bY: Int, res: Vec2i = Vec2i()) = plus(res, this, bX, bY)
    ...
    @JvmOverloads fun minus(bX: Int, bY: Int, res: Vec2i = Vec2i()) = minus(res, this, bX, bY)
    ...
    @JvmOverloads fun times(bX: Int, bY: Int, res: Vec2i = Vec2i()) = times(res, this, bX, bY)
    ...
    @JvmOverloads fun div(bX: Int, bY: Int, res: Vec2i = Vec2i()) = div(res, this, bX, bY)
    ...
    @JvmOverloads fun rem(bX: Int, bY: Int, res: Vec2i = Vec2i()) = rem(res, this, bX, bY)
    ...
    infix operator fun plus(b: Vec2t<Number>) = plus(Vec2i(), this, b.x.i, b.y.i)

    @JvmOverloads fun plus(bX: Number, bY: Number, res: Vec2i = Vec2i()) = plus(res, this, bX.i, bY.i)
    fun plus(b: Number, res: Vec2i) = plus(res, this, b.i, b.i)
    fun plus(b: Vec2t<Number>, res: Vec2i) = plus(res, this, b.x.i, b.y.i)
    ...
    infix operator fun minus(b: Vec2t<Number>) = minus(Vec2i(), this, b.x.i, b.y.i)

    @JvmOverloads fun minus(bX: Number, bY: Number, res: Vec2i = Vec2i()) = minus(res, this, bX.i, bY.i)
    fun minus(b: Number, res: Vec2i) = minus(res, this, b.i, b.i)
    fun minus(b: Vec2t<Number>, res: Vec2i) = minus(res, this, b.x.i, b.y.i)
    ...
    infix operator fun times(b: Vec2t<Number>) = times(Vec2i(), this, b.x.i, b.y.i)

    @JvmOverloads fun times(bX: Number, bY: Number, res: Vec2i = Vec2i()) = times(res, this, bX.i, bY.i)
    fun times(b: Number, res: Vec2i) = times(res, this, b.i, b.i)
    fun times(b: Vec2t<Number>, res: Vec2i) = times(res, this, b.x.i, b.y.i)
    ...
    infix operator fun div(b: Vec2t<Number>) = div(Vec2i(), this, b.x.i, b.y.i)

    @JvmOverloads fun div(bX: Number, bY: Number, res: Vec2i = Vec2i()) = div(res, this, bX.i, bY.i)
    ...
    infix operator fun rem(b: Vec2t<Number>) = rem(Vec2i(), this, b.x.i, b.y.i)

    @JvmOverloads fun rem(bX: Number, bY: Number, res: Vec2i = Vec2i()) = rem(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun and(bX: Int, bY: Int, res: Vec2i = Vec2i()) = and(res, this, bX, bY)
    ...
    @JvmOverloads fun or(bX: Int, bY: Int, res: Vec2i = Vec2i()) = or(res, this, bX, bY)
    ...
    @JvmOverloads fun xor(bX: Int, bY: Int, res: Vec2i = Vec2i()) = xor(res, this, bX, bY)
    ...
    @JvmOverloads fun shl(bX: Int, bY: Int, res: Vec2i = Vec2i()) = shl(res, this, bX, bY)
    ...
    @JvmOverloads fun shr(bX: Int, bY: Int, res: Vec2i = Vec2i()) = shr(res, this, bX, bY)
    ...
    @JvmOverloads fun inv(res: Vec2i = Vec2i()) = inv(res, this)
    ...
    @JvmOverloads fun and(bX: Number, bY: Number, res: Vec2i = Vec2i()) = and(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun or(bX: Number, bY: Number, res: Vec2i = Vec2i()) = or(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun xor(bX: Number, bY: Number, res: Vec2i = Vec2i()) = xor(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun shl(bX: Number, bY: Number, res: Vec2i = Vec2i()) = shl(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun shr(bX: Number, bY: Number, res: Vec2i = Vec2i()) = shr(res, this, bX.i, bY.i)
