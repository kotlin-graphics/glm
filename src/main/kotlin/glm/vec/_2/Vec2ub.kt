...
class Vec2ub(x: Ubyte, y: Ubyte) : Vec2t<Ubyte>(x, y) {
    ...
    @JvmOverloads fun plus(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = plus(res, this, bX, bY)
    @JvmOverloads fun plus(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = plus(res, this, bX, bY)
    @JvmOverloads fun plus(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = plus(res, this, bX, bY)
    ...
    @JvmOverloads fun minus(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = minus(res, this, bX, bY)
    @JvmOverloads fun minus(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = minus(res, this, bX, bY)
    @JvmOverloads fun minus(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = minus(res, this, bX, bY)
    ...
    @JvmOverloads fun times(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = times(res, this, bX, bY)
    @JvmOverloads fun times(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = times(res, this, bX, bY)
    @JvmOverloads fun times(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = times(res, this, bX, bY)
    ...
    @JvmOverloads fun div(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = div(res, this, bX, bY)
    @JvmOverloads fun div(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = div(res, this, bX, bY)
    @JvmOverloads fun div(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = div(res, this, bX, bY)
    ...
    @JvmOverloads fun rem(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = rem(res, this, bX, bY)
    @JvmOverloads fun rem(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = rem(res, this, bX, bY)
    @JvmOverloads fun rem(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = rem(res, this, bX, bY)
    ...
    infix operator fun plus(b: Vec2t<Number>) = plus(Vec2ub(), this, b.x.i, b.y.i)

    @JvmOverloads fun plus(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = plus(res, this, bX.i, bY.i)
    fun plus(b: Number, res: Vec2ub) = plus(res, this, b.i, b.i)
    fun plus(b: Vec2t<Number>, res: Vec2ub) = plus(res, this, b.x.i, b.y.i)
    ...
    infix operator fun minus(b: Vec2t<Number>) = minus(Vec2ub(), this, b.x.i, b.y.i)

    @JvmOverloads fun minus(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = minus(res, this, bX.i, bY.i)
    fun minus(b: Number, res: Vec2ub) = minus(res, this, b.i, b.i)
    fun minus(b: Vec2t<Number>, res: Vec2ub) = minus(res, this, b.x.i, b.y.i)
    ...
    infix operator fun times(b: Vec2t<Number>) = times(Vec2ub(), this, b.x.i, b.y.i)

    @JvmOverloads fun times(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = times(res, this, bX.i, bY.i)
    fun times(b: Number, res: Vec2ub) = times(res, this, b.i, b.i)
    fun times(b: Vec2t<Number>, res: Vec2ub) = times(res, this, b.x.i, b.y.i)
    ...
    infix operator fun div(b: Vec2t<Number>) = div(Vec2ub(), this, b.x.i, b.y.i)

    @JvmOverloads fun div(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = div(res, this, bX.i, bY.i)
    ...
    infix operator fun rem(b: Vec2t<Number>) = rem(Vec2ub(), this, b.x.i, b.y.i)

    @JvmOverloads fun rem(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = rem(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun and(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = and(res, this, bX, bY)
    @JvmOverloads fun and(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = and(res, this, bX, bY)
    @JvmOverloads fun and(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = and(res, this, bX, bY)
    ...
    @JvmOverloads fun or(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = or(res, this, bX, bY)
    @JvmOverloads fun or(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = or(res, this, bX, bY)
    @JvmOverloads fun or(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = or(res, this, bX, bY)
    ...
    @JvmOverloads fun xor(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = xor(res, this, bX, bY)
    @JvmOverloads fun xor(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = xor(res, this, bX, bY)
    @JvmOverloads fun xor(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = xor(res, this, bX, bY)
    ...
    @JvmOverloads fun shl(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = shl(res, this, bX, bY)
    @JvmOverloads fun shl(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = shl(res, this, bX, bY)
    @JvmOverloads fun shl(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = shl(res, this, bX, bY)
    ...
    @JvmOverloads fun shr(bX: Ubyte, bY: Ubyte, res: Vec2ub = Vec2ub()) = shr(res, this, bX, bY)
    @JvmOverloads fun shr(bX: Byte, bY: Byte, res: Vec2ub = Vec2ub()) = shr(res, this, bX, bY)
    @JvmOverloads fun shr(bX: Int, bY: Int, res: Vec2ub = Vec2ub()) = shr(res, this, bX, bY)
    ...
    infix fun and(b: Vec2t<Number>) = and(Vec2ub(), this, b.x.b, b.y.b)

    fun and(b: Number, res: Vec2ub) = and(res, this, b.i, b.i)
    fun and(b: Vec2t<Number>, res: Vec2ub) = and(res, this, b.x.i, b.y.i)
    @JvmOverloads fun and(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = and(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun or(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = or(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun xor(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = xor(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun shl(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = shl(res, this, bX.i, bY.i)
    ...
    @JvmOverloads fun shr(bX: Number, bY: Number, res: Vec2ub = Vec2ub()) = shr(res, this, bX.i, bY.i)
