...
import glm.vec._3.operators.vec3ul_operators
...
class Vec3ul(x: Ulong, y: Ulong, z: Ulong) : Vec3t<Ulong>(x, y, z) {
    ...
    operator fun plus(b: Vec3t<Number>) = plus(Vec3ul(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun plus(b: Vec3t<Number>, res: Vec3ul = Vec3ul()) = plus(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun minus(b: Vec3t<Number>) = minus(Vec3ul(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun minus(b: Vec3t<Number>, res: Vec3ul = Vec3ul()) = minus(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun times(b: Vec3t<Number>) = times(Vec3ul(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun times(b: Vec3t<Number>, res: Vec3ul = Vec3ul()) = times(res, this, b.x.L, b.y.L, b.z.L)
