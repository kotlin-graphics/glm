...
import glm.vec._3.operators.vec3ui_operators
...
class Vec3ui(x: Uint, y: Uint, z: Uint) : Vec3t<Uint>(x, y, z) {
    ...
    operator fun plus(b: Vec3t<Number>) = plus(Vec3ui(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun plus(b: Vec3t<Number>, res: Vec3ui = Vec3ui()) = plus(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun minus(b: Vec3t<Number>) = minus(Vec3ui(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun minus(b: Vec3t<Number>, res: Vec3ui = Vec3ui()) = minus(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun times(b: Vec3t<Number>) = times(Vec3ui(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun times(b: Vec3t<Number>, res: Vec3ui = Vec3ui()) = times(res, this, b.x.i, b.y.i, b.z.i)
