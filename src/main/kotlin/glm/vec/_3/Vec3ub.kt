...
import glm.vec._3.operators.vec3ub_operators
...
class Vec3ub(x: Ubyte, y: Ubyte, z: Ubyte) : Vec3t<Ubyte>(x, y, z) {
    ...
    operator fun plus(b: Vec3t<Number>) = plus(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun plus(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = plus(res, this, b.x.i, b.y.i, b.z.i)

    fun plus_(bX: Number, bY: Number, bZ: Number) = plus(this, this, bX.i, bY.i, bZ.i)
    infix fun plus_(b: Number) = plus(this, this, b.i, b.i, b.i)
    infix fun plus_(b: Vec3t<Number>) = plus(this, this, b.x.i, b.y.i, b.z.i)


    operator fun minus(b: Number) = minus(Vec3ub(), this, b.i, b.i, b.i)
    operator fun minus(b: Vec3t<Number>) = minus(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun minus(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = minus(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun minus_(b: Vec3t<Number>) = minus(this, this, b.x.i, b.y.i, b.z.i)


    operator fun times(b: Number) = times(Vec3ub(), this, b.i, b.i, b.i)
    operator fun times(b: Vec3t<Number>) = times(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun times(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = times(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun times_(b: Vec3t<Number>) = times(this, this, b.x.i, b.y.i, b.z.i)
