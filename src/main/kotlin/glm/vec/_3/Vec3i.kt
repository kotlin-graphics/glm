...
import glm.vec._3.operators.vec3i_operators
...
class Vec3i(x: Int, y: Int, z: Int) : Vec3t<Int>(x, y, z) {
    ...
    operator fun plus(b: Vec3t<Number>) = plus(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun plus(b: Vec3t<Number>, res: Vec3i = Vec3i()) = plus(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun minus(b: Vec3t<Number>) = minus(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun minus(b: Vec3t<Number>, res: Vec3i = Vec3i()) = minus(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun times(b: Vec3t<Number>) = times(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun times(b: Vec3t<Number>, res: Vec3i = Vec3i()) = times(res, this, b.x.i, b.y.i, b.z.i)
