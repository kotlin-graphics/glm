...
import glm.vec3.Vec3s.Companion.plus
import glm.vec3.Vec3s.Companion.minus
import glm.vec3.Vec3s.Companion.times
import glm.vec3.Vec3s.Companion.div
import glm.vec3.Vec3s.Companion.rem
