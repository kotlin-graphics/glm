...
fun Int.max(other: Int) = java.lang.Integer.max(this, other)
fun Int.min(other: Int) = java.lang.Integer.min(this, other)
...
fun Long.max(other: Long) = java.lang.Long.max(this, other)
fun Long.min(other: Long) = java.lang.Long.min(this, other)
...
fun Float.max(other: Float) = java.lang.Float.max(this, other)
fun Float.min(other: Float) = java.lang.Float.min(this, other)
...
fun Double.max(other: Double) = java.lang.Double.max(this, other)
fun Double.min(other: Double) = java.lang.Double.min(this, other)
