...
import vec.Vec3t
import vec.Vec4t
import vec._3.operators.vec3ub_operators
...
data class Vec3ub(override var x: Ubyte, override var y: Ubyte, override var z: Ubyte) : Vec3t<Ubyte>() {
    ...
    override fun Set(x: Number, y: Number, z: Number): Vec3ub {
        this.x = x.ub
        this.y = y.ub
        this.z = z.ub
        return this
    ...
    operator fun dec(res: Vec3ub = Vec3ub()) = sub(res, this, 1, 1, 1)
    fun dec_() = sub(this, this, 1, 1, 1)


    // -- Specific binary arithmetic operators --

    operator fun plus(b: Ubyte) = add(Vec3ub(), this, b, b, b)
    operator fun plus(b: Byte) = add(Vec3ub(), this, b, b, b)
    operator fun plus(b: Int) = add(Vec3ub(), this, b, b, b)
    operator fun plus(b: Vec3ub) = add(Vec3ub(), this, b.x, b.y, b.z)

    fun add(bX: Ubyte, bY: Ubyte, bZ: Ubyte, res: Vec3ub = Vec3ub()) = add(res, this, bX, bY, bZ)
    fun add(bX: Byte, bY: Byte, bZ: Byte, res: Vec3ub = Vec3ub()) = add(res, this, bX, bY, bZ)
    fun add(bX: Int, bY: Int, bZ: Int, res: Vec3ub = Vec3ub()) = add(res, this, bX, bY, bZ)
    fun add(b: Ubyte, res: Vec3ub = Vec3ub()) = add(res, this, b, b, b)
    fun add(b: Byte, res: Vec3ub = Vec3ub()) = add(res, this, b, b, b)
    fun add(b: Int, res: Vec3ub = Vec3ub()) = add(res, this, b, b, b)
    fun add(b: Vec3ub, res: Vec3ub = Vec3ub()) = add(res, this, b.x, b.y, b.z)

    fun add_(bX: Ubyte, bY: Ubyte, bZ: Ubyte) = add(this, this, bX, bY, bZ)
    fun add_(bX: Byte, bY: Byte, bZ: Byte) = add(this, this, bX, bY, bZ)
    fun add_(bX: Int, bY: Int, bZ: Int) = add(this, this, bX, bY, bZ)
    infix fun add_(b: Ubyte) = add(this, this, b, b, b)
    infix fun add_(b: Byte) = add(this, this, b, b, b)
    infix fun add_(b: Int) = add(this, this, b, b, b)
    infix fun add_(b: Vec3ub) = add(this, this, b.x, b.y, b.z)


    operator fun minus(b: Ubyte) = sub(Vec3ub(), this, b, b, b)
    operator fun minus(b: Byte) = sub(Vec3ub(), this, b, b, b)
    operator fun minus(b: Int) = sub(Vec3ub(), this, b, b, b)
    operator fun minus(b: Vec3ub) = sub(Vec3ub(), this, b.x, b.y, b.z)

    fun sub(bX: Ubyte, bY: Ubyte, bZ: Ubyte, res: Vec3ub = Vec3ub()) = sub(res, this, bX, bY, bZ)
    fun sub(bX: Byte, bY: Byte, bZ: Byte, res: Vec3ub = Vec3ub()) = sub(res, this, bX, bY, bZ)
    fun sub(bX: Int, bY: Int, bZ: Int, res: Vec3ub = Vec3ub()) = sub(res, this, bX, bY, bZ)
    fun sub(b: Ubyte, res: Vec3ub = Vec3ub()) = sub(res, this, b, b, b)
    fun sub(b: Byte, res: Vec3ub = Vec3ub()) = sub(res, this, b, b, b)
    fun sub(b: Int, res: Vec3ub = Vec3ub()) = sub(res, this, b, b, b)
    fun sub(b: Vec3ub, res: Vec3ub = Vec3ub()) = sub(res, this, b.x, b.y, b.z)

    fun sub_(bX: Ubyte, bY: Ubyte, bZ: Ubyte) = sub(this, this, bX, bY, bZ)
    fun sub_(bX: Byte, bY: Byte, bZ: Byte) = sub(this, this, bX, bY, bZ)
    fun sub_(bX: Int, bY: Int, bZ: Int) = sub(this, this, bX, bY, bZ)
    infix fun sub_(b: Ubyte) = sub(this, this, b, b, b)
    infix fun sub_(b: Byte) = sub(this, this, b, b, b)
    infix fun sub_(b: Int) = sub(this, this, b, b, b)
    infix fun sub_(b: Vec3ub) = sub(this, this, b.x, b.y, b.z)


    operator fun times(b: Ubyte) = mul(Vec3ub(), this, b, b, b)
    operator fun times(b: Byte) = mul(Vec3ub(), this, b, b, b)
    operator fun times(b: Int) = mul(Vec3ub(), this, b, b, b)
    operator fun times(b: Vec3ub) = mul(Vec3ub(), this, b.x, b.y, b.z)

    fun mul(bX: Ubyte, bY: Ubyte, bZ: Ubyte, res: Vec3ub = Vec3ub()) = mul(res, this, bX, bY, bZ)
    fun mul(bX: Byte, bY: Byte, bZ: Byte, res: Vec3ub = Vec3ub()) = mul(res, this, bX, bY, bZ)
    fun mul(bX: Int, bY: Int, bZ: Int, res: Vec3ub = Vec3ub()) = mul(res, this, bX, bY, bZ)
    fun mul(b: Ubyte, res: Vec3ub = Vec3ub()) = mul(res, this, b, b, b)
    fun mul(b: Byte, res: Vec3ub = Vec3ub()) = mul(res, this, b, b, b)
    fun mul(b: Int, res: Vec3ub = Vec3ub()) = mul(res, this, b, b, b)
    fun mul(b: Vec3ub, res: Vec3ub = Vec3ub()) = mul(res, this, b.x, b.y, b.z)

    fun mul_(bX: Ubyte, bY: Ubyte, bZ: Ubyte) = mul(this, this, bX, bY, bZ)
    fun mul_(bX: Byte, bY: Byte, bZ: Byte) = mul(this, this, bX, bY, bZ)
    fun mul_(bX: Int, bY: Int, bZ: Int) = mul(this, this, bX, bY, bZ)
    infix fun mul_(b: Ubyte) = mul(this, this, b, b, b)
    infix fun mul_(b: Byte) = mul(this, this, b, b, b)
    infix fun mul_(b: Int) = mul(this, this, b, b, b)
    infix fun mul_(b: Vec3ub) = mul(this, this, b.x, b.y, b.z)
    ...
    operator fun plus(b: Number) = add(Vec3ub(), this, b.i, b.i, b.i)
    operator fun plus(b: Vec3t<Number>) = add(Vec3ub(), this, b.x.i, b.y.i, b.z.i)

    fun add(bX: Number, bY: Number, bZ: Number, res: Vec3ub = Vec3ub()) = add(res, this, bX.i, bY.i, bZ.i)
    fun add(b: Number, res: Vec3ub = Vec3ub()) = add(res, this, b.i, b.i, b.i)
    fun add(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = add(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun minus(b: Number) = sub(Vec3ub(), this, b.i, b.i, b.i)
    operator fun minus(b: Vec3t<Number>) = sub(Vec3ub(), this, b.x.i, b.y.i, b.z.i)

    fun sub(bX: Number, bY: Number, bZ: Number, res: Vec3ub = Vec3ub()) = sub(res, this, bX.i, bY.i, bZ.i)
    fun sub(b: Number, res: Vec3ub = Vec3ub()) = sub(res, this, b.i, b.i, b.i)
    fun sub(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = sub(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun times(b: Number) = mul(Vec3ub(), this, b.i, b.i, b.i)
    operator fun times(b: Vec3t<Number>) = mul(Vec3ub(), this, b.x.i, b.y.i, b.z.i)

    fun mul(bX: Number, bY: Number, bZ: Number, res: Vec3ub = Vec3ub()) = mul(res, this, bX.i, bY.i, bZ.i)
    fun mul(b: Number, res: Vec3ub = Vec3ub()) = mul(res, this, b.i, b.i, b.i)
    fun mul(b: Vec3t<Number>, res: Vec3ub = Vec3ub()) = mul(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun div(b: Vec3t<Number>) = div(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun div(b: Vec3t<Number>, res: Vec3ub) = div(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun rem(b: Vec3t<Number>) = rem(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun rem(b: Vec3t<Number>, res: Vec3ub) = rem(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun and(b: Vec3t<Number>) = and(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun and(b: Vec3t<Number>, res: Vec3ub) = and(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun or(b: Vec3t<Number>) = or(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun or(b: Vec3t<Number>, res: Vec3ub) = or(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun xor(b: Vec3t<Number>) = xor(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun xor(b: Vec3t<Number>, res: Vec3ub) = xor(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun shl(b: Vec3t<Number>) = shl(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun shl(b: Vec3t<Number>, res: Vec3ub) = shl(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun shr(b: Vec3t<Number>) = shr(Vec3ub(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun shr(b: Vec3t<Number>, res: Vec3ub) = shr(res, this, b.x.i, b.y.i, b.z.i)
