...
import vec.Vec3t
import vec.Vec4t
import vec._3.operators.vec3i_operators
...
data class Vec3i(override var x: Int, override var y: Int, override var z: Int) : Vec3t<Int>() {
    ...
    override fun Set(x: Number, y: Number, z: Number): Vec3i {
        this.x = x.i
        this.y = y.i
        this.z = z.i
        return this
    ...
    operator fun inc(res: Vec3i = Vec3i()) = add(res, this, 1, 1, 1)
    fun inc_() = add(this, this, 1, 1, 1)


    operator fun dec(res: Vec3i = Vec3i()) = sub(res, this, 1, 1, 1)
    fun dec_() = sub(this, this, 1, 1, 1)


    // -- Specific binary arithmetic operators --

    operator fun plus(b: Int) = add(Vec3i(), this, b, b, b)
    operator fun plus(b: Vec3i) = add(Vec3i(), this, b.x, b.y, b.z)

    fun add(bX: Int, bY: Int, bZ: Int, res: Vec3i = Vec3i()) = add(res, this, bX, bY, bZ)
    fun add(b: Int, res: Vec3i = Vec3i()) = add(res, this, b, b, b)
    fun add(b: Vec3i, res: Vec3i = Vec3i()) = add(res, this, b.x, b.y, b.z)

    fun add_(bX: Int, bY: Int, bZ: Int) = add(this, this, bX, bY, bZ)
    infix fun add_(b: Int) = add(this, this, b, b, b)
    infix fun add_(b: Vec3i) = add(this, this, b.x, b.y, b.z)


    operator fun minus(b: Int) = sub(Vec3i(), this, b, b, b)
    operator fun minus(b: Vec3i) = sub(Vec3i(), this, b.x, b.y, b.z)

    fun sub(bX: Int, bY: Int, bZ: Int, res: Vec3i = Vec3i()) = sub(res, this, bX, bY, bZ)
    fun sub(b: Int, res: Vec3i = Vec3i()) = sub(res, this, b, b, b)
    fun sub(b: Vec3i, res: Vec3i = Vec3i()) = sub(res, this, b.x, b.y, b.z)

    fun sub_(bX: Int, bY: Int, bZ: Int) = sub(this, this, bX, bY, bZ)
    infix fun sub_(b: Int) = sub(this, this, b, b, b)
    infix fun sub_(b: Vec3i) = sub(this, this, b.x, b.y, b.z)


    operator fun times(b: Int) = mul(Vec3i(), this, b, b, b)
    operator fun times(b: Vec3i) = mul(Vec3i(), this, b.x, b.y, b.z)

    fun mul(bX: Int, bY: Int, bZ: Int, res: Vec3i = Vec3i()) = mul(res, this, bX, bY, bZ)
    fun mul(b: Int, res: Vec3i = Vec3i()) = mul(res, this, b, b, b)
    fun mul(b: Vec3i, res: Vec3i = Vec3i()) = mul(res, this, b.x, b.y, b.z)

    fun mul_(bX: Int, bY: Int, bZ: Int) = mul(this, this, bX, bY, bZ)
    infix fun mul_(b: Int) = mul(this, this, b, b, b)
    infix fun mul_(b: Vec3i) = mul(this, this, b.x, b.y, b.z)
    ...
    operator fun plus(b: Number) = add(Vec3i(), this, b.i, b.i, b.i)
    operator fun plus(b: Vec3t<Number>) = add(Vec3i(), this, b.x.i, b.y.i, b.z.i)

    fun add(bX: Number, bY: Number, bZ: Number, res: Vec3i = Vec3i()) = add(res, this, bX.i, bY.i, bZ.i)
    fun add(b: Number, res: Vec3i = Vec3i()) = add(res, this, b.i, b.i, b.i)
    fun add(b: Vec3t<Number>, res: Vec3i = Vec3i()) = add(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun minus(b: Number) = sub(Vec3i(), this, b.i, b.i, b.i)
    operator fun minus(b: Vec3t<Number>) = sub(Vec3i(), this, b.x.i, b.y.i, b.z.i)

    fun sub(bX: Number, bY: Number, bZ: Number, res: Vec3i = Vec3i()) = sub(res, this, bX.i, bY.i, bZ.i)
    fun sub(b: Number, res: Vec3i = Vec3i()) = sub(res, this, b.i, b.i, b.i)
    fun sub(b: Vec3t<Number>, res: Vec3i = Vec3i()) = sub(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun times(b: Number) = mul(Vec3i(), this, b.i, b.i, b.i)
    operator fun times(b: Vec3t<Number>) = mul(Vec3i(), this, b.x.i, b.y.i, b.z.i)

    fun mul(bX: Number, bY: Number, bZ: Number, res: Vec3i = Vec3i()) = mul(res, this, bX.i, bY.i, bZ.i)
    fun mul(b: Number, res: Vec3i = Vec3i()) = mul(res, this, b.i, b.i, b.i)
    fun mul(b: Vec3t<Number>, res: Vec3i = Vec3i()) = mul(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun div(b: Vec3t<Number>) = div(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun div(b: Vec3t<Number>, res: Vec3i) = div(res, this, b.x.i, b.y.i, b.z.i)
    ...
    operator fun rem(b: Vec3t<Number>) = rem(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun rem(b: Vec3t<Number>, res: Vec3i) = rem(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun and(b: Vec3t<Number>) = and(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun and(b: Vec3t<Number>, res: Vec3i) = and(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun or(b: Vec3t<Number>) = or(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun or(b: Vec3t<Number>, res: Vec3i) = or(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun xor(b: Vec3t<Number>) = xor(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun xor(b: Vec3t<Number>, res: Vec3i) = xor(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun shl(b: Vec3t<Number>) = shl(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun shl(b: Vec3t<Number>, res: Vec3i) = shl(res, this, b.x.i, b.y.i, b.z.i)
    ...
    infix fun shr(b: Vec3t<Number>) = shr(Vec3i(), this, b.x.i, b.y.i, b.z.i)
    ...
    fun shr(b: Vec3t<Number>, res: Vec3i) = shr(res, this, b.x.i, b.y.i, b.z.i)
