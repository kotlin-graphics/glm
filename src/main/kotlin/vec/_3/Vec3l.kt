...
import vec.Vec3t
import vec.Vec4t
import vec._3.operators.vec3l_operators
...
data class Vec3l(override var x: Long, override var y: Long, override var z: Long) : Vec3t<Long>() {
    ...
    override fun Set(x: Number, y: Number, z: Number): Vec3l {
        this.x = x.L
        this.y = y.L
        this.z = z.L
        return this
    ...
    operator fun inc(res: Vec3l = Vec3l()) = add(res, this, 1, 1, 1)
    fun inc_() = add(this, this, 1, 1, 1)


    operator fun dec(res: Vec3l = Vec3l()) = sub(res, this, 1, 1, 1)
    fun dec_() = sub(this, this, 1, 1, 1)


    // -- Specific binary arithmetic operators --

    operator fun plus(b: Long) = add(Vec3l(), this, b, b, b)
    operator fun plus(b: Vec3l) = add(Vec3l(), this, b.x, b.y, b.z)

    fun add(bX: Long, bY: Long, bZ: Long, res: Vec3l = Vec3l()) = add(res, this, bX, bY, bZ)
    fun add(b: Long, res: Vec3l = Vec3l()) = add(res, this, b, b, b)
    fun add(b: Vec3l, res: Vec3l = Vec3l()) = add(res, this, b.x, b.y, b.z)

    fun add_(bX: Long, bY: Long, bZ: Long) = add(this, this, bX, bY, bZ)
    infix fun add_(b: Long) = add(this, this, b, b, b)
    infix fun add_(b: Vec3l) = add(this, this, b.x, b.y, b.z)


    operator fun minus(b: Long) = sub(Vec3l(), this, b, b, b)
    operator fun minus(b: Vec3l) = sub(Vec3l(), this, b.x, b.y, b.z)

    fun sub(bX: Long, bY: Long, bZ: Long, res: Vec3l = Vec3l()) = sub(res, this, bX, bY, bZ)
    fun sub(b: Long, res: Vec3l = Vec3l()) = sub(res, this, b, b, b)
    fun sub(b: Vec3l, res: Vec3l = Vec3l()) = sub(res, this, b.x, b.y, b.z)

    fun sub_(bX: Long, bY: Long, bZ: Long) = sub(this, this, bX, bY, bZ)
    infix fun sub_(b: Long) = sub(this, this, b, b, b)
    infix fun sub_(b: Vec3l) = sub(this, this, b.x, b.y, b.z)


    operator fun times(b: Long) = mul(Vec3l(), this, b, b, b)
    operator fun times(b: Vec3l) = mul(Vec3l(), this, b.x, b.y, b.z)

    fun mul(bX: Long, bY: Long, bZ: Long, res: Vec3l = Vec3l()) = mul(res, this, bX, bY, bZ)
    fun mul(b: Long, res: Vec3l = Vec3l()) = mul(res, this, b, b, b)
    fun mul(b: Vec3l, res: Vec3l = Vec3l()) = mul(res, this, b.x, b.y, b.z)

    fun mul_(bX: Long, bY: Long, bZ: Long) = mul(this, this, bX, bY, bZ)
    infix fun mul_(b: Long) = mul(this, this, b, b, b)
    infix fun mul_(b: Vec3l) = mul(this, this, b.x, b.y, b.z)
    ...
    operator fun plus(b: Number) = add(Vec3l(), this, b.L, b.L, b.L)
    operator fun plus(b: Vec3t<Number>) = add(Vec3l(), this, b.x.L, b.y.L, b.z.L)

    fun add(bX: Number, bY: Number, bZ: Number, res: Vec3l = Vec3l()) = add(res, this, bX.L, bY.L, bZ.L)
    fun add(b: Number, res: Vec3l = Vec3l()) = add(res, this, b.L, b.L, b.L)
    fun add(b: Vec3t<Number>, res: Vec3l = Vec3l()) = add(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun minus(b: Number) = sub(Vec3l(), this, b.L, b.L, b.L)
    operator fun minus(b: Vec3t<Number>) = sub(Vec3l(), this, b.x.L, b.y.L, b.z.L)

    fun sub(bX: Number, bY: Number, bZ: Number, res: Vec3l = Vec3l()) = sub(res, this, bX.L, bY.L, bZ.L)
    fun sub(b: Number, res: Vec3l = Vec3l()) = sub(res, this, b.L, b.L, b.L)
    fun sub(b: Vec3t<Number>, res: Vec3l = Vec3l()) = sub(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun times(b: Number) = mul(Vec3l(), this, b.L, b.L, b.L)
    operator fun times(b: Vec3t<Number>) = mul(Vec3l(), this, b.x.L, b.y.L, b.z.L)

    fun mul(bX: Number, bY: Number, bZ: Number, res: Vec3l = Vec3l()) = mul(res, this, bX.L, bY.L, bZ.L)
    fun mul(b: Number, res: Vec3l = Vec3l()) = mul(res, this, b.L, b.L, b.L)
    fun mul(b: Vec3t<Number>, res: Vec3l = Vec3l()) = mul(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun div(b: Vec3t<Number>) = div(Vec3l(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun div(b: Vec3t<Number>, res: Vec3l) = div(res, this, b.x.L, b.y.L, b.z.L)
    ...
    operator fun rem(b: Vec3t<Number>) = rem(Vec3l(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun rem(b: Vec3t<Number>, res: Vec3l) = rem(res, this, b.x.L, b.y.L, b.z.L)
    ...
    infix fun and(b: Vec3t<Number>) = and(Vec3l(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun and(b: Vec3t<Number>, res: Vec3l) = and(res, this, b.x.L, b.y.L, b.z.L)
    ...
    infix fun or(b: Vec3t<Number>) = or(Vec3l(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun or(b: Vec3t<Number>, res: Vec3l) = or(res, this, b.x.L, b.y.L, b.z.L)
    ...
    infix fun xor(b: Vec3t<Number>) = xor(Vec3l(), this, b.x.L, b.y.L, b.z.L)
    ...
    fun xor(b: Vec3t<Number>, res: Vec3l) = xor(res, this, b.x.L, b.y.L, b.z.L)
    ...
    infix fun shl(b: Vec3t<Number>) = shl(Vec3l(), this, b.x.L, b.y.L, b.z.L)

    infix fun shl_(b: Number) = shl(this, this, b.L, b.L, b.L)
    infix fun shl_(b: Vec3t<Number>) = shl(this, this, b.x.L, b.y.L, b.z.L)

    fun shl(b: Number, res: Vec3l) = shl(res, this, b.L, b.L, b.L)
    fun shl(b: Vec3t<Number>, res: Vec3l) = shl(res, this, b.x.L, b.y.L, b.z.L)
    ...
    infix fun shr(b: Vec3t<Number>) = shr(Vec3l(), this, b.x.L, b.y.L, b.z.L)

    infix fun shr_(b: Number) = shr(this, this, b.L, b.L, b.L)
    infix fun shr_(b: Vec3t<Number>) = shr(this, this, b.x.L, b.y.L, b.z.L)

    fun shr(b: Number, res: Vec3l) = shr(res, this, b.L, b.L, b.L)
    fun shr(b: Vec3t<Number>, res: Vec3l) = shr(res, this, b.x.L, b.y.L, b.z.L)
