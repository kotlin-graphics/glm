...
import glm.i
import vec._2.Vec2i
import vec._2.Vec2i.Companion.plus
import vec._2.Vec2i.Companion.div
import vec._2.Vec2i.Companion.times
import vec._2.Vec2i.Companion.rem
import vec._2.Vec2i.Companion.minus
...
fun Int.add(b: Vec2i, res: Vec2i) = plus(res, b, this, this)
infix fun Int.add_(b: Vec2i) = plus(b, b, this, this)

infix operator fun Int.minus(b: Vec2i) = minus(Vec2i(), this, this, b)
fun Int.sub(b: Vec2i, res: Vec2i) = minus(res, b, this, this)
infix fun Int.sub_(b: Vec2i) = minus(b, this, this, b)

infix operator fun Int.times(b: Vec2i) = times(Vec2i(), b, this, this)
fun Int.mul(b: Vec2i, res: Vec2i) = times(res, b, this, this)
infix fun Int.mul_(b: Vec2i) = times(b, b, this, this)
...
fun Number.add(b: Vec2i, res: Vec2i) = plus(res, b, this.i, this.i)
infix fun Number.add_(b: Vec2i) = plus(b, b, this.i, this.i)

infix operator fun Number.minus(b: Vec2i) = minus(Vec2i(), this.i, this.i, b)
fun Number.sub(b: Vec2i, res: Vec2i) = minus(res, b, this.i, this.i)
infix fun Number.sub_(b: Vec2i) = minus(b, this.i, this.i, b)

infix operator fun Number.times(b: Vec2i) = times(Vec2i(), b, this.i, this.i)
fun Number.mul(b: Vec2i, res: Vec2i) = times(res, b, this.i, this.i)
infix fun Number.mul_(b: Vec2i) = times(b, b, this.i, this.i)
