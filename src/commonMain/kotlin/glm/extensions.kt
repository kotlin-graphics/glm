...
val Number.ub get() = toInt().toUByte()
val Number.us get() = toInt().toUShort()
val Number.ui get() = toInt().toUInt()
val Number.ul get() = toLong().toULong()
...
val Char.ub get() = code.toUByte()
val Char.ui get() = code.toUInt()
val Char.ul get() = code.toULong()
val Char.us get() = code.toUShort()
